document.addEventListener('DOMContentLoaded', () => {
    ...
    progress += increment;
    console.log(`Raw progress value: ${progress}`); // Debugging line
    const roundedProgress = Math.round(progress);
    console.log(`Rounded progress value: ${roundedProgress}`); // Debugging line
    ...
    progressLog.innerText = message;
        ...
        const generateKeyProcess = async () => {
            ...
            for (let i = 0; i < game.attemptsNumber ; i++) {
                ...
                updateProgress(((100 / game.attemptsNumber) / keyCount), 'In progress......');
                if (hasCode) {
                    break;
                }
            }
